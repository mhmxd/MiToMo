...
namespace Multi.Cursor
{
    internal class Str
    {
        ...
        public static string START_LAST_ENTRY = "start_last_entry";
        ...
        //public static string TARGET_DOWN = "target_down";
        //public static string TARGET_UP = "target_up";
        public static string START_LAST_RE_ENTRY = "start_last_re_entry";
