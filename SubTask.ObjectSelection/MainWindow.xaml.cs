...
namespace SubTask.ObjectSelection
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            this.TrialInfo($"Showing object area at {areaRect}");
            ...
            Canvas.SetLeft(_objectArea, areaRect.Left);
            Canvas.SetTop(_objectArea, areaRect.Top);
        ...
        private void ShowObject(TObject tObject, Brush color, MouseEvents mouseEvents)
        {
            ...
            Canvas.SetLeft(objRectangle, tObject.Position.X);
            Canvas.SetTop(objRectangle, tObject.Position.Y);
